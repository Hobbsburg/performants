...
st.page_link("pages/International_Formants_Database.py", label = "Page 1: The International Formant Database")
st.page_link("pages/Performants_Practice_(French).py", label = "Page 2: Performants Practice (French)")
